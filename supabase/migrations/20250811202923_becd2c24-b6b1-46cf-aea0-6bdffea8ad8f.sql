-- Conversations and Messages schema for chat history
...
CREATE POLICY IF NOT EXISTS "Users can view messages of their conversations"
ON public.messages
FOR SELECT
USING (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Users can insert messages into their conversations"
ON public.messages
FOR INSERT
WITH CHECK (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Users can update messages of their conversations"
ON public.messages
FOR UPDATE
USING (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Users can delete messages of their conversations"
ON public.messages
FOR DELETE
USING (
  EXISTS (
...
CREATE TRIGGER IF NOT EXISTS touch_conversations_updated_at_on_message
